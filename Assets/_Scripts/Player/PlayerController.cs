...
namespace UnityTutorial.PlayerControl
{
        public class PlayerController : MonoBehaviour
    {
        ...
        private Animator _animator;
         ...
         private int _yVelHash; // Changed _vVelHash to _yVelHash to represent the Y-axis
         ...
         private void Move()
         {
             ...
             _playerRigibody.velocity = new Vector3(targetVelocity.x, _playerRigibody.velocity.y, targetVelocity.z);
         ...
         private void CamMovement()
         {
             ...
             var mouseY = _inputManager.Look.y; // Corrected to lowercase 'y'
             Camera.position = CameraRoot.position;
             _xRotation -= mouseY * MouseSensitivity * Time.deltaTime;
             _xRotation = Mathf.Clamp(_xRotation, UpperLimit, BottomLimit);

             Camera.localRotation = Quaternion.Euler(_xRotation, 0, 0);
             transform.Rotate(Vector3.up, mouseX * MouseSensitivity * Time.deltaTime); // Corrected spelling and used Rotate
         }
     }
}
